...
const TabArr = [
    ...
    { route: 'Milkmanslist', label: 'Search', icon: 'search', color: "black", component: Milkmanslist },
    { route: 'Following', label: 'Favourite', icon: 'heart', color: "black", component: Following },
